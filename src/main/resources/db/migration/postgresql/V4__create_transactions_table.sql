CREATE TABLE transactions (
    ...
    reversal_of_transaction_id  UUID NULL REFERENCES transactions(id)
);
...
SET reversal_of_transaction_id = sub.original_transaction_id
FROM (
    SELECT r.transaction_id AS reversal_transaction_id, MIN(o.transaction_id::text)::uuid AS original_transaction_id
...
WHERE t.id = sub.reversal_transaction_id;
